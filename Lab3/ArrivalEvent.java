...
class ArrivalEvent extends Event {
  ...
  public Event[] simulate() {
    ...
    } else if (this.shop.availableCounterQueue() != null) {
      Counter counter = this.shop.availableCounterQueue();
      return new Event[] {
        new JoinCounterQueueEvent(this.getTime(), this.customer, counter)
      };
    } else {
